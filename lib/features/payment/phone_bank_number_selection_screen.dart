import 'package:eazrdaily/features/payment/phone_number_entry_screen.dart';
import 'package:flutter/material.dart';

class PhoneBankSelectionScreen extends StatefulWidget {
  const PhoneBankSelectionScreen({super.key});

  @override
  _PhoneBankSelectionScreenState createState() => _PhoneBankSelectionScreenState();
}

class _PhoneBankSelectionScreenState extends State<PhoneBankSelectionScreen> {
                        ...
                        child: ListTile(
                          ...
                          onTap: () {
                            ...
                            Navigator.push(
                              context,
                              MaterialPageRoute(
                                builder: (context) => PhoneNumberPaymentScreen(
                                  bankName: bank['name'],
