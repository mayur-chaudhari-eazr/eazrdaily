...
class TransferToAccountScreen extends StatefulWidget {
  final String bankName;
  final String bankLogo;
  final String accountNumber;
  final String amount; // Accept amount as a parameter

  const TransferToAccountScreen({
    super.key,
  ...
  @override
  _TransferToAccountScreenState createState() => _TransferToAccountScreenState();
}

class _TransferToAccountScreenState extends State<TransferToAccountScreen> {
