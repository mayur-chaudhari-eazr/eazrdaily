...
import 'package:eazrdaily/features/managecard/reset_pin_success_screen.dart'; // Replace with your own import

class ConfirmPinCodeSettings extends StatefulWidget {
  const ConfirmPinCodeSettings({super.key});

  @override
  _ConfirmPinCodeSettingsState createState() => _ConfirmPinCodeSettingsState();
}

class _ConfirmPinCodeSettingsState extends State<ConfirmPinCodeSettings> {
  String passcode = '';
  ...
  void _navigateToNextScreen() {
    Navigator.push(
      context,
      MaterialPageRoute(builder: (context) => const ResetPinSuccessScreen()),
    );
  }
