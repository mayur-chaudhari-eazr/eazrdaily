...
class _RegistrationScreenState extends State<RegistrationScreen> {
            ...
            children: [
              ...
              Container(
                ...
                decoration: BoxDecoration(
                  ...
                  borderRadius: BorderRadius.circular(12), // Larger radius for rounded corners
                ),
                child: Column(
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
                    Row(
                      children: [
                        Icon(Icons.security, color: isDarkMode ? Colors.white70 : Colors.black54),
  ...
  Widget buildStepItem(String stepNumber, String stepDescription, bool isDarkMode) {
    return Row(
      children: [
        CircleAvatar(
