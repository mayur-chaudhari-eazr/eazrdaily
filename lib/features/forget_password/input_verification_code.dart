import 'package:eazrdaily/features/forget_password/reset_password_screen.dart';
import 'package:flutter/material.dart';
import 'package:flutter_countdown_timer/flutter_countdown_timer.dart';
import 'package:flutter_otp_text_field/flutter_otp_text_field.dart';

class InputOtpVerificationScreen extends StatefulWidget {
  const InputOtpVerificationScreen({super.key});

  @override
  _InputOtpVerificationScreenState createState() => _InputOtpVerificationScreenState();
}

class _InputOtpVerificationScreenState extends State<InputOtpVerificationScreen> {
